...
public class ViewPagerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        logger.log(Level.INFO, "Received intent **************************************** ");
        ...
        if (getIntent() != null) {
            ...
            Toast.makeText(this,article.getMarque_p(),Toast.LENGTH_SHORT).show();
           // mViewPager.setCurrentItem(position);
        }
        mViewPager.setAdapter(new SamplePagerAdapter(article.getImags_p()));
   ...
   private   ArrayList<String> sDrawables;
       public SamplePagerAdapter(Collection<String> a)
       {
           sDrawables =new ArrayList<>(a) ;
       }
        ...
        public View instantiateItem(ViewGroup container, int position) {
            ...
            photoView.setImageUri("http://192.168.1.6/"+sDrawables.get(position));
