...
public class ImageUrlUtils {
    ...
    static Command cartListImageUri = new Command();
    public static ArrayList<Command> listArt=new ArrayList<>();
    ...
    // Methods for Cart
    public void addCartListImageUri(LingeCommand wishlistImageUri) {
        this.cartListImageUri.getLignsCommand().add(wishlistImageUri);
    }

    public void removeCartListImageUri(int position) {
        ((ArrayList<LingeCommand>)this.cartListImageUri.getLignsCommand()).remove(position);

    }

    public Command getCartListImageUri(){ return this.cartListImageUri; }
}
