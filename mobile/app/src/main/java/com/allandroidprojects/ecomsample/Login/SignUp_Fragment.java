...
public class SignUp_Fragment extends Fragment implements OnClickListener {
	...
	private static EditText fullName, emailId, mobileNumber, location,prenom,
			password, confirmPassword;
	private static TextView login;
	private static Button signUpButton;
	private static CheckBox terms_conditions;
	private static MainActivity2 mActivity;
	private static ProgressBar progressBar3;
	...
	public void onClick(View v) {
		...
		case R.id.already_user:
			...
			new MainActivity2().replaceLoginFragment();
			break;
		}
	...
	private void checkValidation() {
		...
		// Else do signup or do your stuff
			...
			us.setNom_U(getFullName);
			us.setType(0);
			us.setPrenom_U(getpren);
			us.setEmail_U(getEmailId);
			us.setLocation_U(getLocation);
			us.setNumperPhone_U(getMobileNumber);
			//**us.setCodepostal_U(getcodp);
			us.setPassword_U(getPassword);
		//	signUpButton.setVisibility(View.GONE);
         progressBar3.setVisibility(View.VISIBLE);
			mActivity.chatClientInterface.inscription(us);
