...
public class List_Achat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        killFilter.addAction("List_Achat");
    ...
    public static class SimpleStringRecyclerViewAdapter
        ...
        public void onBindViewHolder(final SimpleStringRecyclerViewAdapter.ViewHolder holder, final int position) {
            ...
            holder.getId.setText("Identificateur : "+listArticle.get(position).getId_C()+"");
    ...
    private class MyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equalsIgnoreCase("List_Achat")) {
                logger.log(Level.INFO, "repond vent **************************");
                Utilisateur u=(Utilisateur) intent.getSerializableExtra("List_Achat");
                listVent.addAll(u.getListVentAchteur());
